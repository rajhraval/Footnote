...
open class Snapshot: NSObject {
    ...
    open class func snapshot(_ name: String, timeWaitingForIdle timeout: TimeInterval = 20) {
        ...
        if Snapshot.waitForAnimations {
            ...
            do {
                // The simulator name contains "Clone X of " inside the screenshot file when running parallelized UI
                // Tests on concurrent devices
    ...
    class func waitForLoadingIndicatorToDisappear(within timeout: TimeInterval) {
        ...
        let loadingIndicatorDisappeared = XCTNSPredicateExpectation(predicate: NSPredicate(format: "exists == false"),
...
private extension XCUIElementAttributes {
    var isNetworkLoadingIndicator: Bool {
        ...
        let hasNewLoadingIndicatorSize = frame.size.width.isBetween(46,
                                                                    and: 47) && frame.size.height.isBetween(2,
                                                                                                            and: 3)
